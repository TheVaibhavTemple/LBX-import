...
public class LockboxSummaryInfo {
    ...
    public String getAspecDate() {
        return aspecDate;
    }

    public void setAspecDate(String aspecDate) {
        this.aspecDate = aspecDate;
    }

    public Integer getLockboxCount() {
        return lockboxCount;
    }

    public void setLockboxCount(Integer lockboxCount) {
        this.lockboxCount = lockboxCount;
    }
}
